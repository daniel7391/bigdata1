...
public class MainPage extends BaseController {
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			tourPlanJoinList = tourPlanJoinService.selectTourPlanJoin();
			tourPlanJoinList2 = tourPlanJoinService.selectTourPlanJoin2();
		...
		request.setAttribute("tourPlanJoinList2", tourPlanJoinList2);
