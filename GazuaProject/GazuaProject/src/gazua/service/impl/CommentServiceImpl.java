...
public class CommentServiceImpl implements CommentService {
   ...
   public void deleteCommentByTourPlanId(Comment comment) throws Exception {
      try {
         int result = sqlSession.delete("CommentMapper.deleteCommentByTourPlanId", comment);
      } catch (Exception e) {
         sqlSession.rollback();
         logger.error(e.getLocalizedMessage());
         throw new Exception("덧글 삭제에 실패했습니다.");
   ...
   public void deleteCommentByOut(Comment comment) throws Exception {
      try {
         int result = sqlSession.delete("CommentMapper.deleteCommentByOut", comment);
      } catch (Exception e) {
         sqlSession.rollback();
         logger.error(e.getLocalizedMessage());
         throw new Exception("회원의 댓글 삭제에 실패했습니다.");
      } finally {
         sqlSession.commit();
      }
