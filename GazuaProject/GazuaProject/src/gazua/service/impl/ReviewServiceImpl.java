...
public class ReviewServiceImpl implements ReviewService{
   ...
   @Override
   public void deleteReviewByMemberId(Review review) throws Exception {
      try{
         int result = sqlSession.delete("ReviewMapper.deleteReviewByMemberId", review);
      } catch (Exception e) {
         sqlSession.rollback();
         logger.error(e.getLocalizedMessage());
         throw new Exception("회원의 리뷰 삭제에 실패했습니다.");
      } finally {
         sqlSession.commit();
      }
   }
