	...
	<header>
        ...
        <div id="main">  
           ...
           <div class="board col-sm-9">
             ...
             <ul id="grid">
             <c:choose>
             	<c:when test="${fn:length(tourPlanList) > 0}">
               		<c:forEach var="tourPlan" items="${tourPlanList}">
		                    <li class="item">
		                        <div class="item-box">
		                            <div class="item-content">
		                            	<c:url var="readUrl" value="/gazua/planinfo.do">
											<c:param name="id" value="${tourPlan.id}" />
										</c:url>
		                                <a href="${readUrl}">
		                                	<img src="${tourPlan.imagePath}" class="img" />
		                                </a>
		                                <h3 class="title">
		                                    <a href="${readUrl}" target="_blank">${tourPlan.name}</a>
		                                </h3>
		                                <p class="state">${tourPlan.intro} </p>
